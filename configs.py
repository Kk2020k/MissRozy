...
FQDN = str(getenv('FQDN', BIND_ADRESS)) if not ON_HEROKU or getenv('FQDN','stream20k-kannadhasa2020.koyeb.app') else APP_NAME+'.herokuapp.com'
...
BANNED_CHANNELS = list(set(int(x) for x in str(getenv("BANNED_CHANNELS", "-1001950363096")).split())) 
STREAM_LOGS = environ.get('STREAM_LOGS','-1001950363096')
SESSION = environ.get('SESSION','MissRozy')
CUSTOM_CAPTION = environ.get('CUSTOM_CAPTION')


class Config(object):
	API_ID = int(os.environ.get("API_ID", "26872474"))
	API_HASH = os.environ.get("API_HASH", "f8d3a289bf28a13a7159ad0b2ed114e7")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","5916738939:AAE0iLo5uIBu0X0SeZwQke3hMTxIDcjodvM")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "MissRozy_BOT")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1001850979293))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "5211097531"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://King:king@file.fuxewu1.mongodb.net/?retryWrites=true&w=majority")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1001632042507")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001850979293")
  ...
  # LP_CUSTOM_TEMPLATE= os.environ.get("LP_CUSTOM_TEMPLATE","{file_name} - example \n\n Please Upadate this template acording to you @LazyDeveloperr ")
	BANNED_CHAT_IDS = list(set(int(x) for x in os.environ.get("BANNED_CHAT_IDS", "-1001950363096").split()))
